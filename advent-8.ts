...
function segmentsInCommon(characterCode1: string, characterCode2: string): number {
    ...
    for(let characterCode1Index = 0; characterCode1Index < characterCode1.length; characterCode1Index++) {
        for(let characterCode2Index = 0; characterCode2Index < characterCode2.length; characterCode2Index++) {
            if(characterCode1[characterCode1Index] === characterCode2[characterCode2Index]) {
...
function partOne8(): void {
    const outputValues: Array<Array<string>> = [];
    let digitOccurences: Array<number> = Array(9).fill(0); 
    ...
    for(let outputValueIndex = 0; outputValueIndex < outputValues.length; outputValueIndex++) {
        for(let digitIndex = 0; digitIndex < outputValues[outputValueIndex].length; digitIndex++) {
            switch (outputValues[outputValueIndex][digitIndex].length) {
                case 2:
                    digitOccurences[1]++;
                    break;
                case 3:
    ...
    let occurrences1478 = digitOccurences.reduce((a, b) => a+b);
    console.log("Occurences of 1, 4, 7 or 8: ", occurrences1478);
}
    ...
    for(let signalPatternIndex = 0; signalPatternIndex < signalPatterns.length; signalPatternIndex++) {
        ...
        for(let digitIndex = 0; digitIndex < signalPatterns[signalPatternIndex].length; digitIndex++) {
            ...
            switch (signalPatterns[signalPatternIndex][digitIndex].length) {
                case 2:
                    ...
                    break;
                case 3:
                    digitSegments[7] = signalPatterns[signalPatternIndex][digitIndex];
                    break;
                case 4:
                    digitSegments[4] = signalPatterns[signalPatternIndex][digitIndex];
                    break;
                case 7:
                    digitSegments[8] = signalPatterns[signalPatternIndex][digitIndex];
                    break;
                default:
                    //Do nothing
            }
        ...
        for(let digitIndex = 0; digitIndex < signalPatterns[signalPatternIndex].length; digitIndex++) {
            switch (signalPatterns[signalPatternIndex][digitIndex].length) {
                ...
                else if(segmentsInCommon(signalPatterns[signalPatternIndex][digitIndex], digitSegments[4]) === 2) {
                    digitSegments[2] = signalPatterns[signalPatternIndex][digitIndex];
                }
                else {
                    digitSegments[5] = signalPatterns[signalPatternIndex][digitIndex];
                }
                break;
            case 6: 
                ...
                else if(segmentsInCommon(signalPatterns[signalPatternIndex][digitIndex], digitSegments[4]) === 4) {
                    digitSegments[9] = signalPatterns[signalPatternIndex][digitIndex];
                }
                else {
                    digitSegments[0] = signalPatterns[signalPatternIndex][digitIndex];
                }
                break;
            default:
                //Do nothing
