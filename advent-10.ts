...
const puzzleInput10 = stdinBuffer.toString();
let puzzleInputArray10: Array<String> = puzzleInput10.split('\n').map(String);

function checkIfCharacterIsLegal(character: string, characterStack: Array<string>): boolean {
    switch (character) {
        case "(":
            characterStack.push(")");
            return true;
        ...
        case "<":
            ...
            return true;
        case ")":
            return character === characterStack.pop()
        case "]":
            return character === characterStack.pop()
        case "}":
            return character === characterStack.pop()
        case ">":
            return character === characterStack.pop()  
        default:
            console.log("Unexpected character: ", character, "Ignoring.")
            return true; 
    }    
}

function illegalCharacterScore(character: string): number {
    switch (character) {
        case ")":
            return 3;
        case "]":
        ...
        case ">":
            return 25137;
        default:
            console.log("Unexpected character. Returning 0.");
            return 0;
    }
}
...
function autocompleteScore(character: string): number {
    switch (character) {
        case ")":
            return 1;
        case "]":
        ...
        case ">":
            return 4;
        default:
            console.error("Unexpected character: ", character, " Something went wrong before this function. Returning negative infinity");
            return Number.NEGATIVE_INFINITY;
    }
}

function partOne10(): void {
    const characterStack: Array<string> = [];
    const illegalCharacterScores: Array<number> = [];
    ...
    const illegalCharacterScoreSum = illegalCharacterScores.reduce((a, b) => a + b);
    console.log("Total syntax error score is: ", illegalCharacterScoreSum);
}

function partTwo10(): void {
    const characterStack: Array<string> = [];
    ...
    console.log("Middle completion score is: ", allScores[Math.floor(allScores.length/2)]);
}
